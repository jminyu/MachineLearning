...
N=numcases;
 ...
 train_err_percentage(epoch) = train_err(epoch)/(numcases*numbatches);
...
for batch = 1:testnumbatches
 ...
 test_err_percentage(epoch) = test_err(epoch)/(testnumcases*testnumbatches);
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 save mnistclassify_weights_S2 w1 w2 w3 w_class
 save mnistclassify_error_S2 test_err test_crerr train_err train_crerr;
